    ...
    <main className="min-h-screen bg-background">
      ...
      <article className="pt-32 pb-16 lg:pt-40 lg:pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-24">
            <div
              className="text-muted-foreground leading-relaxed space-y-6 prose prose-lg prose-invert max-w-none 
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground font-serif mt-4">
                Make it a Night to Remember
              </h2>
              <p className="text-muted-foreground mt-4 leading-relaxed">
                Inspired by the story? Reserve your spot now for an elite
                experience in our lounge.
              </p>
            </div>
