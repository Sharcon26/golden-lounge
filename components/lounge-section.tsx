...
export function LoungeSection() {
    return (
        <section className="py-24 lg:py-32 bg-background border-b border-white/5">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="order-2 lg:order-2 flex flex-col items-center lg:items-start">
                        ...
                        >
                            <a href="https://www.sevenrooms.com/reservations/gdlounge" target="_blank" rel="noopener noreferrer" id="reservation-button-lounge">
                                Reserve a Table
                            </a>
                        </Button>
                    </div>
